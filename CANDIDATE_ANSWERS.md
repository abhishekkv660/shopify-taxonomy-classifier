...
- **AI/ML:** `sentence-transformers` for local RAG, Groq (LLaMA3) for hyper-fast text inference, Groq (Qwen) for Vision.
...
**Assumptions & Risks:**
- **Assumption:** Access to high-throughput LLM API keys (Groq).
...
- **Day 2 (8 hrs): Core ML Logic**
  ...
  - Integrating Groq/LLaMA3 for text classification and Groq Qwen for Vision processing.
